...
public class Constant {
    ...
    public final static String yybStr = "/NumIQLogic.txt";//替换
    public final static File yyb = new File(path + "NumIQLogic.txt");//替换
    public final static String SHARE_TITLE = "数字的思考";//替换
    ...
    public final static String gameUrl = adsUrl + "/NumIQLogic";

    public final static String SHARE_TEXT = "太难了,我不行,有种你来!\n" +
            "点击后,请使用浏览器下载安装.";
    public static final  String title = "您好,我是小智";
}
