...
import com.ads.puzzle.disnep.window.AdGameWin;
...
public class MoreGameScreen extends BaseScreen {
    ...
    public MoreGameScreen(Puzzle game, BaseScreen bs) {
        super(game);
        baseScreen = bs;
    }
        ...
        for (int i = 0; i < seriesList.size(); i++) {
            ...
            seriesBtn.addListener(new InputListener() {
                ...
                public boolean touchDown(InputEvent event, float x, float y,
                    ...
                    addActor(new AdGameWin(getOtherFont(), MoreGameScreen.this, series.getReadmeImage(), series.getUrl()));
                    return true;
                }
            });
